{{ $activity->created_at->diffForHumans() }} - {{ $activity->present()->username }} removed a comment from the {{strtolower((new \ReflectionClass($activity->commentable()))->getShortName())}}:
