...
class DiscussionWasModifiedEvent extends Event {
	...
	{
		return '<strong>' . htmlentities($username) . '</strong> modified the discussion <strong>' . htmlentities($discussionTitle) . '</strong> in the task <strong>' . htmlentities($taskName) . '</strong>';
	}
}