...
class SubtaskWasModifiedEvent extends Event {
	...
	{
		return '<strong>' . htmlentities($username) . '</strong> modified the subtask <strong>' . htmlentities($subtaskName) . '</strong> in the task <strong>' . htmlentities($taskName) . '</strong>';
	}
}